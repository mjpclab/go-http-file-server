...
"$ghfs" -l 3003 --prefix foo/bar -r "$fs/vhost1" -a ":/lorem/ipsum:$fs/vhost2" --dir-index index.txt --force-dir-slash -E '' &
sleep 0.05 # wait server ready

assert $(curl_head_status 'http://127.0.0.1:3003/foo/bar') '301'
...
assert $(curl_head_status 'http://127.0.0.1:3003/foo/bar/hello?sort=T') '301'
...
assert $(curl_head_status 'http://127.0.0.1:3003/foo/bar/lorem') '301'
...
assert $(curl_head_status 'http://127.0.0.1:3003/foo/bar/lorem/ipsum') '301'
...
assert $(curl_head_status 'http://127.0.0.1:3003/foo/bar/lorem/ipsum/a') '301'
